...
QT_MOC_LITERAL(1, 13, 7), // "SIG_win"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5) // "color"

    },
    "checkerboard\0SIG_win\0\0color"
};
...
void checkerboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        checkerboard *_t = static_cast<checkerboard *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SIG_win((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (checkerboard::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&checkerboard::SIG_win)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject checkerboard::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_checkerboard.data,
      qt_meta_data_checkerboard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *checkerboard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_checkerboard.stringdata0))
        return static_cast<void*>(const_cast< checkerboard*>(this));
...
// SIGNAL 0
void checkerboard::SIG_win(int _t1)
{
